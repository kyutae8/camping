...
<div id="layout_header" class="layout_header">
	<div class="util_wrap">
		<div class="resp_wrap">
			<!-- bookmark -->
			<ul class="bookmark">
				<li><a>관리자[<%=loginMember.getName() %>]님 환영합니다.</a></li>
				<li><a></a></li>
			</ul>
			<ul class="util_wrap_menu2">
				...
				<li><a href="index.jsp?workgroup=base&work=print">Main</a></li>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			...
			<!-- logo -->
			<h1 class="logo_area">
			<a href="index.jsp?workgroup=admin&work=admin_main" target="_self"><img height="150px" src="<%=request.getContextPath() %>/images/mheader.png" alt="(주) 귀사의 회사명" /></a>			</h1>
						...
						<div class="designCategoryNavigation">
							<ul class="respCategoryList">
								<li class="custom_nav_link">
									<a class="categoryDepthLink" href="index.jsp?workgroup=admin&work=member_manager"><em>회원관리</em></a>
								</li>
								<li class="custom_nav_link">
									<a class="categoryDepthLink" href="index.jsp?workgroup=admin&work=sproduct_manager"><em>s제품관리</em></a>
								</li>
	
								<li class="custom_nav_link">
									<a class="categoryDepthLink" href="index.jsp?workgroup=admin&work=sorder_manager"><em>s주문관리</em></a>
								</li>
								<li class="custom_nav_link">
									<a class="categoryDepthLink" href="index.jsp?workgroup=admin&work=product_manager"><em>제품관리</em></a>
								</li>
								<li class="custom_nav_link">
									<a class="categoryDepthLink" href="index.jsp?workgroup=admin&work=order_manager"><em>구매관리</em></a>
								</li>
								<li class="custom_nav_link">
									<a class="categoryDepthLink" href="index.jsp?workgroup=admin&work=board_manager"><em>게시글관리</em></a>
								</li>
