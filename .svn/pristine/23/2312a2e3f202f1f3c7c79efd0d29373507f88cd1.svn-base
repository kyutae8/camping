	...
	<div id="boardlayout">
		<div class="subpage_wrap">
			...
			<div class="subpage_container">
				...
				<div id="bbsview">
					<form name="writeform" id="writeform" method="post" action="<%=request.getContextPath()%>/index.jsp?workgroup=board/question&work=question_modify_action" enctype="multipart/form-data">
