...
<%
	...
	if(mr.getParameter("secret")!=null){//전달값이 있는 경우(비밀글)
	...
	out.println("location.href='"+request.getContextPath()+"/index.jsp?workgroup=board/question&work=question_list&pageNum="+pageNum+"';");
	out.println("</script>");
