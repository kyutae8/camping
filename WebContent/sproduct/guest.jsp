...
<form name="joinForm" id="join" method="post" action="<%=request.getContextPath() %>/index.jsp?workgroup=sproduct&work=guest_action">
<input type="hidden" name="pcolor" value="<%=sproduct.getColor() %>">
<input type="hidden" name="pname" value="<%=sproduct.getName() %>">
<input type="hidden" name="pprice" value="<%=sproduct.getPrice() %>">
