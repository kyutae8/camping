...
<div id="product">
	...
	<form action="<%=request.getContextPath()%>/index.jsp?workgroup=admin&work=sorder_detail_modify_action"
	...
	<table>
		<tr>
			...
			<td>
				...
				<input type="text" name="productCode" id="productCode" value="<%=sproduct.getCode().split("_")[1]%>">
			</td>
		<tr>
		<tr>
			<td>제품명</td>
		...
		<tr>
			<td colspan="2"><button type="submit">주문변경</button></td>
		</tr>
	</table>
	</form>
